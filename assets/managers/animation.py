...
def player_anim(self):
    ...
    pygame.draw.rect(common.loaded_level.hud, (16, 16, 16), pygame.Rect(
        0, 0, constants.screen_scale*24, constants.screen_scale*12))
    pygame.draw.rect(common.loaded_level.hud, (128, 16, 16), pygame.Rect(-constants.screen_scale, -
                     constants.screen_scale, constants.screen_scale*25, constants.screen_scale*13,), constants.screen_scale)
    pygame.draw.rect(common.loaded_level.hud, (96, 16, 16), pygame.Rect(constants.screen_scale,
                     constants.screen_scale, constants.screen_scale*21*(self.hp/self.max_hp), constants.screen_scale*9))
    pygame.draw.rect(common.loaded_level.hud, (16, 16, 16), pygame.Rect(common.loaded_level.hud.get_width(
    )-constants.screen_scale*23, 0, constants.screen_scale*24, constants.screen_scale*12))
    pygame.draw.rect(common.loaded_level.hud, (16, 128, 16), pygame.Rect(common.loaded_level.hud.get_width(
    )-constants.screen_scale*24, -constants.screen_scale, constants.screen_scale*25, constants.screen_scale*13), constants.screen_scale)
    pygame.draw.rect(common.loaded_level.hud, (16, 96, 16), pygame.Rect(common.loaded_level.hud.get_width(
    )-constants.screen_scale*22, constants.screen_scale, constants.screen_scale*21*(self.xp % 100/100), constants.screen_scale*9))
    ...
    if pygame.mouse.get_focused() and pygame.mouse.get_pressed(5)[0]:
        ...
        arm_image.blit(self.inventory["main_0"].texture, (int((arm_image.get_width(
        )-constants.screen_scale)/2), int((arm_image.get_height()-constants.screen_scale)/2)))
        angle = self.angle
        ...
        pos = (int((self.x-common.loaded_level.camera[0])*constants.screen_scale+w_offset), int(
            (self.y-common.loaded_level.camera[1])*constants.screen_scale+h_offset))
    ...
    if keys[pygame.K_g]:
        common.loaded_level.hud.blit(pygame.transform.scale(common.run.intermediary.map, (common.run.intermediary.map.get_width(
        )*(constants.screen_scale*2-1), common.run.intermediary.map.get_height()*(constants.screen_scale*2-1))), (0, 0))
