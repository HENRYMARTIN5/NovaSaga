...
if pygame.display.get_caption()[0] == "Nova Saga: All Inclusive!":
    pygame.display.set_icon(pygame.image.load(
        os.path.join(ui_path, "rainbow-icon.png")))
else:
    pygame.display.set_icon(pygame.image.load(
        os.path.join(ui_path, "icon.png")))
...
DEFKEYBINDS = {"left": pygame.K_a, "right": pygame.K_d, "jump": pygame.K_w, "action1": "lclick",
               "action2": "rclick", "action3": pygame.K_q, "inventory": pygame.K_e, "interact": pygame.K_SPACE}
